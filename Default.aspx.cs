...
namespace WebApplication1
{
    ...
    {
        public string ENETSDOMAIN { get; set; } = ConfigurationManager.AppSettings[Constants.AppSettingKeys.ENETS_Domain];
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                txnReq.Value = strpayload;
                hmac.Value = strhmac;
                keyId.Value = trans.KeyID;
